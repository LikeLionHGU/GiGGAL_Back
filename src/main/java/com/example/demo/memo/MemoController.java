...
public class MemoController {
    ...
    public ResponseEntity<MemoResponseAboutMemoId> addMemo(@RequestBody MemoRequest memoRequest, @PathVariable String bookId) {
    ...
    public ResponseEntity<List<MemoResponse>> findMemosOfTheUser(@PathVariable String bookId) {
